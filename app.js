...
app.get("/", (req, res) => {
    ...
    // randing page // 
    let randingNotebook = fs.readFileSync("./uploads/a222b36b2c238da368ddef6e6eec3e98"); // 맥북
    let randingChromeBrower = fs.readFileSync("./uploads/884e198a266486bc96e7a2d9235fd730"); // 크롬 브라우저
    let randingMonthly = fs.readFileSync("./uploads/ea0da3497e94651df1b3ec379415e14f"); // monthly
    let randingDaily = fs.readFileSync("./uploads/2cb21d1644686da9ac6d429f58c8e26c"); // daily

    let randingIconImac = fs.readFileSync("./uploads/83c9525c89d6b9aa4651b65766dc3559"); // 3dIconImac
    let randingIconMacbook = fs.readFileSync("./uploads/920592705f332b242356b189bb42beda"); // 3dIconMacbook
    let randingIconTablet = fs.readFileSync("./uploads/7883b21f690031c85c6cfb962ffb414f"); // 3dIconTablet
    let randingIconPhone = fs.readFileSync("./uploads/42de8817686327b5b04ef87b5cf0c908"); // 3dIconPhone

    let notebook = imageDataUri.encode(randingNotebook, "jpg");
    let ChromeBrower = imageDataUri.encode(randingChromeBrower, "jpg");
    let Monthly = imageDataUri.encode(randingMonthly, "jpg");
    let Daily = imageDataUri.encode(randingDaily, "jpg");
    let IconImac = imageDataUri.encode(randingIconImac, "jpg");
    let IconMacbook = imageDataUri.encode(randingIconMacbook, "jpg");
    let IconTablet = imageDataUri.encode(randingIconTablet, "jpg");
    let IconPhone = imageDataUri.encode(randingIconPhone, "jpg");
    res.status(200).send({ data: { 
        signupPhotos: { macbook, iphone }, 
        randingPhotos: { notebook, ChromeBrower, Monthly, Daily, IconImac, IconMacbook, IconTablet, IconPhone } 
        } 
    })
})
